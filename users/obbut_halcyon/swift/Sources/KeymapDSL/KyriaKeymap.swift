// Kyria Rev4 Keymap in Swift DSL
// SPDX-License-Identifier: GPL-2.0-or-later

/// Kyria keymap using SwiftUI-like DSL
/// This generates the same keymap as the C macros in obbut_halcyon.h
public let kyriaKeymap = Keymap {
...
/// Encoder map for Kyria
public let kyriaEncoderMap: [Layer: EncoderMap] = [

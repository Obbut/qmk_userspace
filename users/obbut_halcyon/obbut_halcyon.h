...
#define ENCODER_DEFAULT_CCW   KC_KB_VOLUME_DOWN
#define ENCODER_DEFAULT_CW    KC_KB_VOLUME_UP
#define ENCODER_QWERTY_CCW    KC_KB_VOLUME_DOWN
#define ENCODER_QWERTY_CW     KC_KB_VOLUME_UP
#define ENCODER_LOWER_CCW     KC_MPRV
#define ENCODER_LOWER_CW      KC_MNXT
#define ENCODER_RAISE_CCW     KC_KB_VOLUME_DOWN

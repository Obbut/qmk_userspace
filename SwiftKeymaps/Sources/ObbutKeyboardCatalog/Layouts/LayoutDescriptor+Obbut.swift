...
extension KyriaRev4Layout: HostFirmwareLayout {
    public var hostDescriptor: LayoutDescriptor { .splitKBKyriaRev4 }
}

extension EloraRev2Layout: HostFirmwareLayout {
    public var hostDescriptor: LayoutDescriptor { .splitKBEloraRev2 }
}

extension Q15MaxLayout: HostFirmwareLayout {
    public var hostDescriptor: LayoutDescriptor { .keychronQ15Max }
}

extension PlanckEZGlowLayout: HostFirmwareLayout {
    public var hostDescriptor: LayoutDescriptor { .zsaPlanckEZGlow }
}
